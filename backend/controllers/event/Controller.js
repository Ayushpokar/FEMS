...
export const createevent = async (req, res) => {
    try {
        ...
        const user_name = await pool.query("SELECT user_name FROM fems.tbl_users WHERE id=$1",[payload.user_id])
        const sendingmail = {
            ...
            <table style="width: 100%;max-width: 600px;border-collapse: collapse;">
                <tr><th style="border: 1px solid #ffffff;padding: 8px;text-align: left;background-color: #96D4D4;width: 30%;">Event Created By</th>
                    <td style="border: 1px solid #ffffff;padding: 8px;text-align: left;background-color: #96D4D4;">${user_name.rows[0].user_name}</td></tr>
